...
const projects = [
  {
    ...
    image: "assets/images/iim-mumbai.jpeg",
  ...
  },
  {
    ...
    image: "assets/images/iit-dhanbad.jpeg",
    description: "Developed a long-term spatial framework for the transformation of an existing 200-acre brownfield campus. The approach focused on strengthening the existing skeleton while accommodating future development, movement and public life.",
    role: "Urban Design Guidelines · Movement Planning · Open Space Strategy",
  ...
  },
  {
    ...
    image: "assets/images/bengaluru-sports-city.jpeg",
    description: "An inclusive sports ecosystem combining professional training facilities, a dedicated Paralympic training centre and public recreational spaces. The masterplan focused on accessibility, connectivity and creating a destination that could function beyond professional sports.",
    role: "Inclusive Design · Accessibility · Sports Infrastructure",
  ...
  },
  {
    ...
    image: "assets/images/goa-fisheries.jpeg",
    description: "Upgradation of fisheries infrastructure for the Directorate of Fisheries Departments, across 25 sites in Goa, addressing a range of operational and community needs. The interventions combined functional infrastructure with amenities that support the everyday activities of fishing communities.",
    role: "DPR Preparation · Community Infrastructure · Design Development",
  ...
  },
  {
    ...
    image: "assets/images/msrtc.jpeg",
    description: "Redevelopment and upgrading of MSRTC bus stations and depots across Maharashtra through a PPP development model, by exploring how transport infrastructure could unlock additional development potential while maintaining its core operational function.",
    role: "Market Studies · FSI Feasibility · Transport Infrastructure · PPP Planning",
  ...
  },
  {
    ...
    image: "assets/images/lamp-safety-audit.jpeg",
  ...
  },
  {
    ...
    image: "assets/images/blend-in.jpeg",
  ...
  },
  {
    ...
    image: "assets/images/infusing-edges.jpeg",
...
function activateWorkTheme(id, keepVisible = true) {
  ...
  // Only do horizontal scrolling on mobile/tablet.
  if (window.innerWidth > 900) return;

  const barRect = themeBar.getBoundingClientRect();
  const linkRect = activeLink.getBoundingClientRect();

  const leftEdge = barRect.left + 16;
  const rightEdge = barRect.right - 16;

  let targetLeft = themeBar.scrollLeft;

  if (linkRect.left < leftEdge) {
    targetLeft += linkRect.left - leftEdge;
  } else if (linkRect.right > rightEdge) {
    targetLeft += linkRect.right - rightEdge;
  }

  if (targetLeft !== themeBar.scrollLeft) {
    themeBar.scrollTo({
      left: targetLeft,
      behavior: "smooth"
    });
